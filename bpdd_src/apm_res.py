...
'''
Author       : LiAo
Date         : 2022-07-06 23:27:39
LastEditTime : 2022-07-06 23:34:38
LastAuthor   : LiAo
...
import timm
from src.base_module import ConvBlock, Residual


class APMRes(nn.Module):

    def __init__(self, in_chs: int, out_chs: int):
        super(APMRes, self).__init__()
