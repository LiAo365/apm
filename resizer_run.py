...
'''
Author       : LiAo
Date         : 2022-07-10 23:45:23
LastEditTime : 2022-07-11 00:35:51
LastAuthor   : LiAo
Description  : Please add file description
'''
import argparse
import os
from src import resizer_train
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight_path', type=str,
                        default='/data/liao/code/apm/result/resizer/weight/')
    parser.add_argument('--log_path', type=str,
                        default='/data/liao/code/apm/result/resizer/log/')
    parser.add_argument('--model', type=str, default='apm')
    parser.add_argument('--result_path', type=str,
                        default='/data/liao/code/apm/result/resizer/result/')
