...
'''
Author       : LiAo
Date         : 2022-07-09 23:47:04
LastEditTime : 2022-07-10 01:25:01
LastAuthor   : LiAo
...
if __name__ == '__main__':
    ...
    best_weight = "/data/liao/code/apm/result/apm/weight/static_best_weight.pth"
    ...
    model = apm.MultiClassification(
        backbone="tf_efficientnetv2_b2", num_classes=3)
    model.load_state_dict(torch.load(
        best_weight, map_location=torch.device('cpu')))
    model.eval()
    ...
    save_path = "/data/liao/code/apm/images/longitudinal_crack/cam/061_backbone_blocks_5_long.jpg"
